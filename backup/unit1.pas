...
begin
 ...
 repeat
   while zahlen[l]<Mitte do Inc(l);   //Index der Zahl Links die Größer als der Pivot ist

   while zahlen[r]>Mitte do Dec(r);    //Index der Zahl rechts die Kleiner als der Pivot ist
